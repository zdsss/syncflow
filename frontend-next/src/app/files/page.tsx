...
import {
  ...
  Download, Eye, MoreHorizontal, Edit, FileSpreadsheet, FileImage, PanelLeft,
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="flex flex-1 min-h-0">
          {/* Mobile Tree Toggle */}
          <button onClick={() => setShowTree(true)} className="md:hidden absolute top-[3.5rem] left-12 z-10 p-2 text-gray-500 hover:text-gray-700">
            <PanelLeft className="w-5 h-5" />
          </button>
          <Sheet open={showTree} onOpenChange={setShowTree}>
            <SheetContent side="left" className="w-[280px] p-0">
              <div className="px-3 py-2 border-b border-gray-100 pt-10">
              ...
              <div className="flex-1 overflow-y-auto py-2">
                <TreeRenderer nodes={fileTree} expanded={expandedNodes} onToggle={toggleNode} selectedId={selectedFolder} onSelect={(id) => { setSelectedFolder(id); setShowTree(false); }} depth={0} />
              </div>
            </SheetContent>
          </Sheet>

          {/* File Tree */}
          <div className="hidden md:flex md:w-[260px] border-r border-gray-200 flex-col shrink-0">
