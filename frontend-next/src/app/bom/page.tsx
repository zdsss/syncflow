...
import {
  ...
  Edit, Plus, Eye, MoreHorizontal, X, ArrowUp, ArrowDown, PanelLeft,
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="flex flex-1 min-h-0">
          ...
          {/* Tree */}
          <div className="hidden md:flex md:w-[240px] border-r border-gray-200 flex-col shrink-0">
      ...
      {showSpecModal && editingSpec && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50" onClick={() => setShowSpecModal(false)}>
          <div className="bg-white rounded-lg shadow-xl w-full max-w-[440px] mx-4 max-h-[80vh]" onClick={(e) => e.stopPropagation()}>
      ...
      {showConstraintModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50" onClick={() => setShowConstraintModal(false)}>
          <div className="bg-white rounded-lg shadow-xl w-full max-w-[560px] mx-4 max-h-[80vh]" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
